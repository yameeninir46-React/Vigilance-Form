...
return (
  <div className="bg-blue-50 min-h-screen p-6">
    ...
    <div className="mb-8">
  <h2 className="text-[16px] font-bold text-blue-900 mb-3">  
        Basic Information
      </h2>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <SelectField
          name="vigilanceDivision"
          label="Name of vigilance department"
    ...
    <h2 className="text-[16px] font-bold text-blue-900 mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <SelectField
          name="vigilanceType"
          label="Type of vigilance checking"
          placeholder="Select"
          options={[
            { value: "routine", label: "Routine Vigilance Checking " },
            { value: "inter", label: "Inter Division Checking" },
            { value: "special", label: "Special Vigilance Checking" },
  ...
  >
    Fetch
        ...
        <TextField
          ...
          placeholder="Enter category tariff"
        />

        <TextField
          name="dcZone"
          label="Name of DC/Zone"
          placeholder="Enter DC/Zone"
        />

        <TextField
          name="divisionOM"
          label="Division (O&M / City)"
          placeholder="Enter O&M / City"
        />

        <TextField
          name="circleOM"
          label="Circle (O&M / City)"
          placeholder="Enter O&M / City"
        />

        <TextField
          name="agreementLoad"
          label="Agreement load"
          placeholder="Enter agreement load"
         />

        <TextField
          name="lastReading"
          label="Last reading recorded in SAP"
        ...
        <TextField
          name="mfFound"
          label="MF (Multiplying factor) as found"
          placeholder="Enter multiplying factor"
        />

        <TextField
          name="mfBilled"
          label="MF (as billed in SAP)"
